...
this.imgURL = _editor_url + '../imgs_gerencia/';
this.debug  = 0;
...
//    ['forecolor','backcolor','separator'],
    ['forecolor','Createlink','InsertTable']];
...
this.btnList = {
    ...
    "inserttable":    ['InsertTable',          'Insert Table',       'editor_action(this.id)',  'ed_insert_table.gif'],
    "htmlmode":       ['HtmlMode',             'View HTML Source',   'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          'Enlarge Editor',     'editor_action(this.id)',  'ed_fullscreen_maximize.gif'],
