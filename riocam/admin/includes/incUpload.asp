...
'========================================================= '
'  Alterado por Cosme Marins em 10/09/03                   '
' Incluida a propriedade Size no objeto file para informar '
' o tamanho do arquivo                                     '
'=========================================================='
'  Alterado por Cosme Marins em 22/02/05                   '
' Incluida a propriedade extFile no objeto file para       '
            ...
            Do Until (lngPosBoundary = InStrB(strBRequest, strBBoundary & UStr2Bstr("--")))
                ...
                If lngPosFileName <> 0 And lngPosFileName < InStrB(lngPosEnd, strBRequest, strBBoundary) Then 'It is a file
                    ...
                    If strFileName <> "" And strBContent <> "" Then
                        ...
                        objFile.ExtFile = Right(strFileName, Len(strFileName) - InStrRev(strFileName, "."))
                        objFile.ContentType = strContentType
                        objFile.Blob = strBContent
												objFile.Size = LenB(strBContent)
...
'========================================================='
    ...
    public function ItemByKey(Key)
        ...
        ItemByKey = m_objDicItems.item(cstr(Key))
...
'========================================================='
    ...
    Public Property Get ExtFile() : ExtFile = m_strExtFile : End Property
    Public Property Let ExtFile(vIn) : m_strExtFile = vIn : End Property
    Public Property Get Blob() : Blob = m_Blob : End Property
    Public Property Let Blob(vIn) : m_Blob = vIn : End Property
    Public Property Get Size() : Size = m_Size : End Property
...
'			On error goto resume next
        ...
        Set objFSO = Server.CreateObject("Scripting.FileSystemObject")
         'Response.Write Server.mappath("/") & "<br>"
				 'Response.Write Path & ", " & m_strFileName
