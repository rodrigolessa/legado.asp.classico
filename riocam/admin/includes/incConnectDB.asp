...
'		rs2.Open strRSSource, conn
		...
		If Err.Number <> 0 then
			response.write "Erro no sistema <br> Descrição do Erro: " & Err.Description & VbCrLf & "Fonte: " & Err.Source & VbCrLf & "Arquivo: " & Request.ServerVariables("SCRIPT_NAME") & VbCrLf & "ID do Usuário: " & Session("Id_Usuario") & VbCrLf & "String SQL: " & strRSSource & ""
			response.flush
		End If
